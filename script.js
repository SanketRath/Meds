...
const updateTotals = () => {
  ...
  numTasks.innerHTML = `${categoryTasks.length} Medicines`;
  ...
  categories.forEach((category) => {
    ...
    div.innerHTML = `
                ...
                <div class="content">
                  ...
                  <p>${categoryTasks.length} Medicines</p>
                </div>
              </div>
              <div class="options">
...
const renderTasks = () => {
  ...
  if (categoryTasks.length === 0) {
    tasksContainer.innerHTML = `<p class="no-tasks">No Medicines added for this category</p>`;
  } else {
